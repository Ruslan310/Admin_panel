...
export default function ComponentCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setPackageType(initialValues.packageType);
    setCalories(initialValues.calories);
    setCarbons(initialValues.carbons);
    setFats(initialValues.fats);
    setProteins(initialValues.proteins);
    setRecipe(initialValues.recipe);
    setPrice(initialValues.price);
    setPicture(initialValues.picture);
    setWeightInGram(initialValues.weightInGram);
    setErrors({});
  };
  const validations = {
    name: [{ type: "Required" }],
