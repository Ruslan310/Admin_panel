...
export default function CustomerCreateForm(props) {
  ...
  const [wpId, setWpId] = React.useState(initialValues.wpId);
      ...
      <TextField
        ...
        onChange={(e) => {
          ...
          if (onChange) {
            ...
            value = result?.wpId ?? value;
          }
          if (errors.wpId?.hasError) {
            runValidationTasks("wpId", value);
          }
          setWpId(value);
        }}
        onBlur={() => runValidationTasks("wpId", wpId)}
        errorMessage={errors.wpId?.errorMessage}
        hasError={errors.wpId?.hasError}
        {...getOverrideProps(overrides, "wpId")}
      ></TextField>
      <TextField
        label="Company"
        isRequired={false}
